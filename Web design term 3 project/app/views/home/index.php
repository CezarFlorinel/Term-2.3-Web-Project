  ...
  <main>
    ...
    <div class="container mx-auto grid grid-cols-1 gap-4">
      ...
      <div class="event-bg rounded-lg p-6">
        <img src="https://placehold.co/300x200" alt="A vibrant dance event with people enjoying music and performances"
          class="rounded-lg">
      ...
      <!-- Food -->
      <div class="event-bg rounded-lg p-6">
        <img src="https://placehold.co/300x200" alt="Delicious food offerings from various Harlem restaurants"
          class="rounded-lg">
      ...
      <div class="event-bg rounded-lg p-6">
        <img src="https://placehold.co/300x200"
          alt="Historical sites and museums offering a walk through Harlem's history" class="rounded-lg">
