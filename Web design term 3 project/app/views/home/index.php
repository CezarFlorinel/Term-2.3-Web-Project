...
<body class="antialiased font-'Open Sans'">
  ...
  <body style="background-color: black; color: white">
    <div style="padding-top: 50px; margin-left: 250px; margin-right: 70px">
      ...
      <div
        style="position: absolute; right: 10%; top: 50%; transform: translate(0, -50%) rotate(12deg); background-color: red; color: white; padding: 8px 32px;">
        Let The Fun Begin
      </div>
    </div>
  </body>
      ...
      <div class="border-t border-gray-400 pt-8">
        ...
        <div class="grid grid-cols-3 gap-4">
          ...
          <div class="col-span-2 text-base flex items-center justify-center"
            style="font-size: 1.4em; margin-right: 250px;">
