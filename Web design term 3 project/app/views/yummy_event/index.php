            ...
            <div class="text-center mb-8 text-white">
                <div class="flex items-center justify-center bg-no-repeat bg-center bg-contain h-72 md:h-96 
                    ...
                    <p class="text-base font-normal text-white rounded-lg lg:text-black">
                        ...
                        array of restaurants that are sure to captivate your taste buds. Dive into a world of
                        gastronomic <br>
        ...
        <section id="restaurants" class="py-8">
            ...
            <div class="grid grid-cols-1 md:grid-cols-3 gap-4 px-4">
                ...
                <div class="bg-white shadow-lg rounded-lg overflow-hidden">
                    <img class="w-full h-56 object-cover object-center" src="assets/images/yummy_event/roemer.png"
                        alt="Cafe de Roemer">
                ...
                <!-- Restaurant 2 -->
                <div class="bg-white shadow-lg rounded-lg overflow-hidden">
                    <img class="w-full h-56 object-cover object-center" src="assets/images/yummy_event/ratat_res.png"
                        alt="Restaurant Ratatouille">
                    <div class="p-4 flex justify-between items-center">
                ...
                <!-- Restaurant 3 -->
                <div class="bg-white shadow-lg rounded-lg overflow-hidden">
                    <img class="w-full h-56 object-cover object-center" src="assets/images/yummy_event/res_ml.png"
                        alt="Restaurant ML">
                    <div class="p-4 flex justify-between items-center">
                ...
                <!-- Restaurant 4 -->
                <div class="bg-white shadow-lg rounded-lg overflow-hidden">
                    <img class="w-full h-56 object-cover object-center" src="assets/images/yummy_event/fris.png"
                        alt="Restaurant Fris">
                    <div class="p-4 flex justify-between items-center">
                ...
                <!-- Restaurant 5 -->
                <div class="bg-white shadow-lg rounded-lg overflow-hidden">
                    <img class="w-full h-56 object-cover object-center" src="assets/images/yummy_event/spektakel.png"
                        alt="Cafe Spektakel">
                    <div class="p-4 flex justify-between items-center">
                ...
                <!-- Restaurant 6 -->
                <div class="bg-white shadow-lg rounded-lg overflow-hidden">
                    <img class="w-full h-56 object-cover object-center" src="assets/images/yummy_event/brinkman.png"
                        alt="Grand Cafe Brinkman">
                    <div class="p-4 flex justify-between items-center">
                ...
                <!-- Restaurant 7 -->
                <div class="bg-white shadow-lg rounded-lg overflow-hidden">
                    <img class="w-full h-56 object-cover object-center" src="assets/images/yummy_event/bistro_tour.png"
                        alt="Urban French Bistro Tours">
                    <div class="p-4 flex justify-between items-center">
                ...
                <!-- CTA Section -->
                <div
                    class="md:col-span-3 bg-black text-white p-8 flex flex-col items-center justify-center text-center">
                    <div class="mb-2">
                        <!-- Reduced margin-bottom from mb-4 to mb-2 for less space -->
                        <h1
                            style="font-size: 35px; font-family: 'Playfair Display', serif; text-align: center; font-weight: bold">
                            Click on "More Info" to make a reservation!</h1>
                    </div>
