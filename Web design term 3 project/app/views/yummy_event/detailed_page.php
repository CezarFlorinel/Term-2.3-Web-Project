    ...
    <main class="container mx-auto px-4 py-8">
        ...
        <div class="mt-12">
            <div class="text-5xl font-bold pt-12 pb-8 text-left">
                <h1
                    style="font-size: 45px; font-family: 'Playfair Display', serif; text-align: Left; font-weight: bold">
        ...
        <div class="mt-12">
            <div class="text-center text-5xl font-bold pt-12 pb-8">
                <h1
                    style="font-size: 50px; font-family: 'Playfair Display', serif; text-align: Center; font-weight: bold">
                    Ratings & Reviews</h1>
            </div>
            <?php
            ...
            <div class="max-w-4xl mx-auto px-4">
                <div class="relative text-center">
                    <div class="inline-block">
                        <img class="w-full h-auto rounded-lg shadow-lg" src="https://placehold.co/700x600"
        ...
        <section class="container mx-auto px-4 py-8 flex flex-col items-center"
            ...
            <?php foreach ($yummyrestaurants as $restaurant): ?>
                ...
                ?>
                <p class="text-2xl mb-6">This restaurant has <span class="font-bold underline"><?= count($sessions) ?>
                    ...
                    Each session has a <span class="font-bold text-yellow-400">price of
                        <?= number_format($sessions[0]->pricesForAdults, 2, '.', '') ?>€</span>, children <span
                        class="font-bold text-yellow-400">under 12 years old</span> have a price of <span
                        class="font-bold text-yellow-400"><?= number_format($sessions[0]->pricesForChildren, 2, '.', '') ?>€</span>.
                </p>
                <div class="bg-white text-black p-6 rounded-lg inline-flex justify-between items-center relative"
                    ...
                    <img src="assets/images/elements/clock.png" alt="Clock"
                        class="absolute top-0 right-0 h-32 w-32 mt-2 mr-2">
                </div>
