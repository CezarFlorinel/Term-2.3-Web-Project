...
<div class="bg-white shadow-md rounded-lg p-6">
    ...
    <div>
        <img id="imageTop" src="<?php echo htmlspecialchars($homepageDataRestaurant->imagePath); ?>" alt="Image 1"
    ...
    <div>
        <img id="imageLocation" src="<?php echo htmlspecialchars($homepageDataRestaurant->locationsImagePath); ?>"
