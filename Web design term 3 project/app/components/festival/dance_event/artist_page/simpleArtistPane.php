...
<div class="bg-black rounded-lg shadow-md overflow-hidden col-span-4 md:col-span-1 flex flex-col">
    ...
    <div class="flex items-center mt-1 ml-2">
        <input type="radio" id="js_price_panel_<?php echo htmlspecialchars($passedTicket->D_TicketID); ?>" name="price"
            value="<?php echo htmlspecialchars($passedTicket->D_TicketID); ?>">
