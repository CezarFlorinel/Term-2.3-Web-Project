...
document.addEventListener("DOMContentLoaded", () => {
    ...
    createBtn.addEventListener('click', function () {
        ...
        const payload = {
            // Assuming your API expects restaurantID, adjust as needed
            restaurantID: 'YourRestaurantID', // Set this to the actual restaurant ID
        ...
        fetch('/api/restaurantIndividualAdmin/addRestaurantSession', {
            ...
            .then(data => {
                ...
                // Optionally, you could clear the input fields or update the list of sessions here
